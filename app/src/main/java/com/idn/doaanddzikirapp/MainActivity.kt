package com.idn.doaanddzikirapp
...
import com.idn.doaanddzikirapp.adapter.ArtikelAdapter
import com.idn.doaanddzikirapp.model.Artikel
import com.idn.doaanddzikirapp.ui.HarianDzikirDoaActivity
import com.idn.doaanddzikirapp.ui.PagiPetangDzikirActivity
import com.idn.doaanddzikirapp.ui.QauliyahShalatActivity
import com.idn.doaanddzikirapp.ui.SetiapSaatDzikirActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setupViewPager() {
        ...
        for (i in 0 until listArtikel.size){
            ...
            // # menetukan lebar dan tinggi indikator
    ...
    private fun initView() {
        val llDzikirDoaShalat: LinearLayout = findViewById(R.id.ll_dzikir_doa_salat)
        ...
        val vpArtikel: ViewPager2 = findViewById(R.id.vp_atikel)
